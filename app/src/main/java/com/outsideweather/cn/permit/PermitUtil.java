...
//			new PermitItem(true, Manifest.permission.READ_EXTERNAL_STORAGE, "读写手机存储"),
//			new PermitItem(true, Manifest.permission.ACCESS_NETWORK_STATE, "获取联网状态"),
//			new PermitItem(true, Manifest.permission.ACCESS_WIFI_STATE, "获取Wifi状态"),
//			new PermitItem(true, Manifest.permission.CAMERA, "拍摄照片"),
//			new PermitItem(false, Manifest.permission.CALL_PHONE, null),
//			new PermitItem(true, Manifest.permission.RECORD_AUDIO,"获取录音权限"),
//			new PermitItem(false, Manifest.permission.READ_LOGS, null),
//			new PermitItem(false, Manifest.permission.SET_DEBUG_APP, null),
//			new PermitItem(false, Manifest.permission.SYSTEM_ALERT_WINDOW, null),
//			new PermitItem(false, Manifest.permission.GET_ACCOUNTS, null),
//			new PermitItem(false, Manifest.permission.WRITE_APN_SETTINGS, null)
	};
