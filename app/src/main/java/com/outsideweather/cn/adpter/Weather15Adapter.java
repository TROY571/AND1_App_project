 ...
 * @author llw
 */
public class Weather15Adapter extends BaseQuickAdapter< WeatherDailyBean.DailyBean, BaseViewHolder> {
    public Weather15Adapter( @Nullable List< WeatherDailyBean.DailyBean> data) {
        super(R.layout.weather_item_15, data);
    }
