...
public class SearchCityAdapter extends BaseQuickAdapter<GeoBean.LocationBean, BaseViewHolder> {
    public SearchCityAdapter( @Nullable List<GeoBean.LocationBean> data) {
