 ...
 *
 */
public class Weather7Adapter extends BaseQuickAdapter< WeatherDailyBean.DailyBean, BaseViewHolder> {
    public Weather7Adapter(@Nullable List< WeatherDailyBean.DailyBean> data) {
    ...
    protected void convert(BaseViewHolder helper, WeatherDailyBean.DailyBean item) {
        ...
        helper.setText(R.id.tv_date,  DateUtils.Week(item.getFxDate()))
                //最高温
