...
public class UploadHelper {
    ...
    //上传仓库名
    private static final String BUCKET_NAME = "weathert";
    private static final String APP_KEY = "LTAI5tSa3KBgwraRGqus1j9o";
    private static final String BUCKET_SECRET = "2xsHG9W4TfhEy8UmxT4KgbWBIUbfLK";
    private static OSS getOSSClient() {
        OSSCredentialProvider credentialProvider =
                new OSSPlainTextAKSKCredentialProvider(APP_KEY ,
                        BUCKET_SECRET);
        return new OSSClient( BaseAplication.getContext(), ENDPOINT, credentialProvider);
    }
